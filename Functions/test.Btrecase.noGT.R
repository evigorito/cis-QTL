...
test_that("input files except covariates", {
  ...
  inp <- btrecase.nogt.v1(gene="ENSG00000184164",
                     chr=22,
                     snps=5*10^5,
                     ...
                     population="EUR", 
                     maf=0.05,
                     min.ase=5,min.ase.snp=5,tag.threshold=.9,q.test="no",
...
test_that("numeric inputs", {
  ...
  inp <- btrecase.nogt.v1(gene="ENSG00000184164",
                     ...
                     maf="0.05", min.ase=5,min.ase.snp=5, min.ase.n=5,tag.threshold=.9,q.test="no",
...
test_that("numeric snps", {
  ...
  inp <- btrecase.gt(gene="ENSG00000184164",
                     ...
                     min.ase=5,min.ase.snp=5,min.ase.n=5,

                     tag.threshold=.9,q.test="no",
                     
                     out="/mrc-bsu/scratch/ev250/EGEUV1/quant/Btrecase/output/chr22/",
                      
                     prefix="num.snps.test")
...
test_that("selected snps, no tagging ", {
