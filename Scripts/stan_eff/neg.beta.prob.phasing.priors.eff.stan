...
functions{
  ...
  real negasepeff_log(int [] Y, int [] g, int [] gase, int [] m, int [] n, int[] s, vector v, vector pH, matrix cov, vector betas, real bj,  real phi, real theta){
...
model {
  ...
  Y ~ negasepeff(g,gase,m,n,s,v,pH,cov,betas,bj,phi,theta);
